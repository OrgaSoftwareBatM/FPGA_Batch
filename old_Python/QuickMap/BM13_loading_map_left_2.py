...
Map.sequence.append(['LH2',0.015])  # 1 e
Map.sequence.append(['LH3',-0.02])
Map.sequence.append(['Timing',0.1])
Map.sequence.append(['LH2',0.015]) # 2 e
Map.sequence.append(['Timing',0.1])

Map.sequence.append(['LH3',-0.15])
Map.sequence.append(['LH2',0.05])
Map.sequence.append(['Timing',10.])  # Meas
#
...
Map.ramp_slot(6,'dLH2_{load}',0.055,0.055,1)
Map.ramp_slot(4,'dLH3_{load}',-0.00,0.00,1)
