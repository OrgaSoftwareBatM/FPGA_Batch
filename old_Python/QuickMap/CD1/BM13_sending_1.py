...
Map.sequence.append(['LH1',0.2])  # Metastable
Map.sequence.append(['LH2',0.15])
Map.sequence.append(['LH3',-0.3])
Map.sequence.append(['RH1',0.2])
Map.sequence.append(['RH2',0.15])
...
#Map.init_val['RD1'] = -0.85
#Map.init_val['RD2'] = -0.825
#Map.ramp_slot(21,'dLH1_{meta}',-0.3,0.15,2)
Map.ramp_slot(22,'dLH2_{meta}',-0.45,0.15,2)
Map.ramp_slot(23,'dLH3_{meta}',-0.45,0.,1)
#Map.ramp_slot(24,'dRH1_{meta}',-0.3,0.15,2) 
Map.ramp_slot(25,'dRH2_{meta}',-0.45,0.15,2)
Map.ramp_slot(26,'dRH3_{meta}',-0.45,0.,1)
#Map.ramp_slot(40,'dRH2_{SAW}',-0.3,0.,2)
#Map.ramp_slot(41,'dRH3_{SAW}',-0.3,0.,1)

#Map.ramp_DAC('LD1',-0.7,-1.0,1)
