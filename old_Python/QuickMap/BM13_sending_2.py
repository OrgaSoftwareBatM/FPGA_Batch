...
Map.sequence.append(['LH2',-0.1])  # Load L&R
...
Map.init_val['LD2'] = -0.745
Map.init_val['RD1'] = -0.781
...
#Map.ramp_slot(33,'dLH3_{meta}',-0.15,-0.75,1)
...
#Map.ramp_slot(32,'dRH2_{meta}',-0.75,-0.15,2)
