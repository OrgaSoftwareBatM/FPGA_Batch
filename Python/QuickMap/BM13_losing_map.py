...
### RIGHT
Map.init_val['RD1'] = -0.838
Map.init_val['RD2'] = -0.778
...
Map.sequence.append(['RH2',-0.])  # load 2 electrons
...
Map.sequence.append(['RP2',-0.])    # Metastable
Map.sequence.append(['RH1',-0.1])  
Map.sequence.append(['RH2',-0.])
Map.sequence.append(['RH3',-0.04])
Map.sequence.append(['TC',0.])
Map.sequence.append(['BC',-0.])
Map.sequence.append(['RV1',-0.])
Map.sequence.append(['RV2',-0.])
...
Map.sweep_dim = [80,201,51]
Map.init_val['RD1'] = -0.838
Map.init_val['RD2'] = -0.778
#Map.ramp_slot(3,'dRH2_{load}',-0.08,0.04,2)
#Map.ramp_slot(4,'dRH3_{load}',-0.04,0.08,1)

#Map.ramp_slot(17,'dRP2_{meta}',-0.3,-0.3,1)
Map.ramp_slot(18,'dRH1_{meta}',-0.15,0.15,1)
#Map.ramp_slot(19,'dRH2_{meta}',-0.08,0.04,2)
Map.ramp_slot(20,'dRH3_{meta}',-0.03,-0.03,1)
#Map.ramp_slot(21,'dTC_{meta}',-0.45,0.45,2)
#Map.ramp_slot(22,'dBC_{meta}',-0.3,0.3,1)
#Map.ramp_slot(23,'dRV1_{meta}',-0.3,0.3,2)
#Map.ramp_slot(24,'dRV2_{meta}',0.,0.,1)
