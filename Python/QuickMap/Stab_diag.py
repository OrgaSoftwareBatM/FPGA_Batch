...
from Merlin_config import DAC_ADC_config
...
folder = '\\\\192.168.137.200\\Partage\\FPGA_Batch_1_8\\Test_Baptiste'
prefix = 'ramp_'
...
Map.sweep_dim = [1001,1001,11]
Map.ramp_DAC('0:0',-0.5,0.5,0)
Map.ramp_DAC('1:1',-1.2,0.5,1)
#Map.ramp_DAC('0:3',0.05,0.05,3)

Map.ADC.uint64s[6] = Map.sweep_dim[0]
