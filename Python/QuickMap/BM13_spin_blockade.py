...
#Map.ramp_slot(7,'t_{wait,log}',0.2,20.,2)
#Map.ramp_slot(10,'t_{wait}',0.,20.,1)
#Map.ramp_slot(9,'t_{read}',0.,1.,1)
#Map.ramp_slot(9,'t_{wait}',0.,10.,1)
#Map.ramp_slot(6,'t_{wait}',0.,20.,1)

#Map.ramp_slot(9,'dRH1_{read}',-0.06,0.12,1)
