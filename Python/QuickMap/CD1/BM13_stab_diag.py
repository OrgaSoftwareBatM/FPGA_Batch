...
Map.ramp_DAC('LH3',0.,-0.,0)
Map.ramp_DAC('LH1',-0.,-0.,1)
#Map.ramp_DAC('LH2',-0.3,-0.9,2)
##Map.ramp_DAC('LH1',-1.3,-1.6,2)
#Map.ramp_DAC('LD1',-0.92,-0.92,1)
#Map.ramp_DAC('LD2',-0.97,-0.97,1)

#Map.ramp_DAC('RH3',-1.2,-0.6,0)
#Map.ramp_DAC('RH1',-0.9,-1.5,1)
#Map.ramp_DAC('RH2',-0.3,-0.9,2)


#Map.ramp_DAC('LD1',-0.7,-1.15,0)
#Map.ramp_DAC('LD2',-0.7,-1.15,1)
#Map.ramp_DAC('RD1',-0.7,-1.15,0)
#Map.ramp_DAC('RD2',-0.7,-1.15,1)

#Map.ramp_DAC('TC',-0.8,-1.4,2)
#Map.ramp_DAC('BC',-1.4,-0.8,2)
...
#Map.ramp_DAC('LD2',-0.55,-1.15,0,init_at=None)
#Map.ramp_DAC('LD1',-0.55,-1.15,1,init_at=None)
#Map.ramp_DAC('LH2',-0.4,-0.85,1,init_at=None)
#Map.ramp_DAC('LD1',-0.55,-0.55,1)
#Map.ramp_DAC('LD2',-1.15,-1.1,1)

#Map.ramp_DAC('RD2',-0.55,-1.15,0,init_at=None)
#Map.ramp_DAC('RD1',-0.55,-1.15,1,init_at=None)
#Map.ramp_DAC('RH2',-0.4,-0.85,1,init_at=None)
#Map.ramp_DAC('RD1',-0.55,-0.55,1)
#Map.ramp_DAC('RD2',-1.13,-1.09,1)
