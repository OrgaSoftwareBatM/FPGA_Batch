...
#Map.ramp_slot(17,'dLH3_{meta}',0.15,-0.45,1)
#Map.ramp_slot(18,'dLH1_{meta}',-0.3,0.3,2)
Map.ramp_slot(19,'dRH1_{meta}',0.3,-0.3,1)
Map.ramp_slot(20,'dRH2_{meta}',-0.45,0.15,2)
