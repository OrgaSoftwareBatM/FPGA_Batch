...
for i in range(76):
    ...
    Map.sequence.append(['RH3',-0.15])
    Map.sequence.append(['RH1',-0.02])
    Map.sequence.append(['RH3',0.058])
    #Map.sequence.append(['RH3',0.0])
    Map.sequence.append(['Timing',0.05])
...
#Map.ramp_slot(16,'dRH1_{read}',-0.09,0.06,1)
#Map.ramp_slot(17,'dRH3_{read}',0.05,0.08,2)
