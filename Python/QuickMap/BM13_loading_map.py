...
Map.init_val['LH1'] = -1.5
Map.init_val['LH2'] = -0.7
...
Map.sequence.append(['LH1',0.08])  # init
...
Map.sequence.append(['LH1',0.3])  # load
...
Map.sequence.append(['LH1',0.08])  # unload
Map.sequence.append(['LH3',0.12])
Map.sequence.append(['Timing',1.])
Map.sequence.append(['LH3',-0.3])
Map.sequence.append(['LH1',0.])
...
Map.sweep_dim = [80,151,100]
Map.init_val['LD1'] = -0.80
Map.init_val['LD2'] = -0.825
Map.ramp_slot(9,'dLH1_{load}',-0.15,0.3,1)
#Map.ramp_slot(10,'dLH3_{load}',-0.15,0.15,1)
#Map.ramp_slot(9,'dLH2_{load}',0.,0.12,1)
#Map.ramp_slot(10,'dLH3_{load}',0.35,0.35,1)

#Map.ramp_DAC('LD1',-0.75,-0.9,1)
#Map.ramp_DAC('LD2',-0.7,-1.,1)
