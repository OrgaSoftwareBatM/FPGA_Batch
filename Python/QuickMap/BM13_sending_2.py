...
Map.sequence.append(['LH2',0.145])  # Load L&R
Map.sequence.append(['RH2',0.305])
...
Map.sequence.append(['LP2',-0.3])     # Meas
Map.sequence.append(['RP2',-0.3]) 
...
Map.sequence.append(['Timing',9.])

Map.sequence.append(['LP2',-0.3])    # Metastable
Map.sequence.append(['RP2',-0.3])
Map.sequence.append(['LH1',-0.3])  
Map.sequence.append(['RH1',-0.3])  
Map.sequence.append(['LH2',-0.3])
Map.sequence.append(['RH2',-0.45])
Map.sequence.append(['LH3',-0.4])
Map.sequence.append(['RH3',-0.4])
Map.sequence.append(['TC',-0.])
Map.sequence.append(['BC',0.])
Map.sequence.append(['LV1',0.])
Map.sequence.append(['RV1',-0.12])
...
Map.sweep_dim = [160,201,201]
Map.init_val['LD1'] = -0.742
Map.init_val['LD2'] = -0.73
Map.init_val['RD1'] = -0.793
Map.init_val['RD2'] = -0.745

Map.ramp_slot(3,'dLH2_{load}',0.,0.3,1)
#Map.ramp_slot(5,'dLH3_{load}',0.4,0.4,2)
Map.ramp_slot(4,'dRH2_{load}',0.15,0.45,2)
#Map.ramp_slot(6,'dRH3_{load}',0.25,0.25,2)

#Map.ramp_slot(27,'dLP2_{meta}',-0.3,-0.3,1)
#Map.ramp_slot(29,'dLH1_{meta}',-0.3,0.3,2)
Map.ramp_slot(31,'dLH2_{meta}',0.2,0.2,2)
#Map.ramp_slot(33,'dLH3_{meta}',-0.1,-0.7,2)
Map.ramp_slot(37,'dLV1_{meta}',0.,0.,1)
#Map.ramp_slot(39,'dLV2_{meta}',0.,0.,1)
#
#Map.ramp_slot(28,'dRP2_{meta}',-0.3,-0.3,1)
#Map.ramp_slot(30,'dRH1_{meta}',-0.45,0.45,2)
#Map.ramp_slot(32,'dRH2_{meta}',-0.45,0.45,1)
#Map.ramp_slot(34,'dRH3_{meta}',-0.,-0.6,1)
Map.ramp_slot(38,'dRV1_{meta}',-0.2,-0.2,1)
#Map.ramp_slot(40,'dRV2_{meta}',0.,0.,1)

Map.ramp_slot(35,'dTC_{meta}',0.05,0.05,2)
#Map.ramp_slot(36,'dBC_{meta}',-0.3,+0.3,2)
...
#Map.ramp_RF('SAW_{power}',24.,24.,1)
#Map.ramp_RF('SAW_{width}',0.150,0.150,1)
