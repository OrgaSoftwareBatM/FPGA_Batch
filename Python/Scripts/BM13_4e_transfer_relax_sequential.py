...
Map.sequence.append(['RH2',0.3])    # RIGHT
Map.sequence.append(['RH3',-0.8])
Map.sequence.append(['RH1',0.3])
Map.sequence.append(['RH2',0.0])

Map.sequence.append(['Timing',15.])  # Relax

Map.sequence.append(['Trigger','1100']) # SEND 1
Map.sequence.append(['Timing',0.05])
Map.sequence.append(['Trigger','1110'])
Map.sequence.append(['RH1',0.45])    # Send pos 2
Map.sequence.append(['RH3',-0.3])
Map.sequence.append(['Trigger','1100']) # SEND 2
Map.sequence.append(['Timing',0.05])
Map.sequence.append(['RH3',-0.8])
Map.sequence.append(['RH1',0.3])
...
Map.segment_param = [100., 5, 45, 62, 45]
...
#Map.ramp_slot(18,'t_{decay}',0.,15,1)
...
#Map.ramp_slot(21,'dRH1_{sending}',0.6,0.,1)
#Map.ramp_slot(21,'dRH1_{sending}',0.52,0.3,1)

#Map.ramp_slot(23,'dRH1_{mixing}',0.45,-0.15,1)
...
#Map.ramp_RF('SAW_{power}',25.,22.,1)
