...
#Map.sweep_dim = [50,2,2,10000]
Map.sweep_dim = [28,13,10000]
...
#Map.segment_param = [94.095, 54, 17, 32, 17]
Map.segment_param = [152.234, 49, 47, 63, 47]
