...
Map.sequence.append(['RH1',0.])  # SENDING POS
Map.sequence.append(['Trigger','1000']) # SEND
Map.sequence.append(['RH1',0.])   # MIXING AFTER RECEPTION
...
Map.segment_param = [90.862, 52, 17, 32, 17]
#
...
Map.ramp_slot(13,'dLH1_{wait}',0.5,0.5,2)
...
#Map.ramp_slot(22,'dRH1_{sending}',0.06,0.3,1)
...
#Map.ramp_Bfield('B_Z',0.050,-0.050,2)
