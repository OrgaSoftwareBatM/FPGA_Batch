...
#Map.sweep_dim = [150,51,5000]
#Map.sweep_dim = [12000,100]
#Map.sweep_dim = [91,5000]
#Map.sweep_dim = [91,1000]
Map.sweep_dim = [10,101,2]
...
Map.segment_param = [231.2, 28, 200]
...
#Map.ramp_slot(5,'dLH2_{load}',-0.05,0.07,1)
#Map.ramp_slot(6,'dLH2_{load}',-0.06,0.06,1)

Map.ramp_slot(9,'dRH2_{load}',-0.1,-0.02,2)
...
#Map.ramp_slot(18,'t_{decay}',0.,10,1)
...
#
#Map.ramp_RF('RF0_{freq}',0.185,0.220,2)
#Map.ramp_RF('RF0_{power}',15.,0.,1)
#Map.ramp_RF('RF1_{freq}',0.110,0.155,2)
