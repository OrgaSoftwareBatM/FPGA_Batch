# -*- coding: utf-8 -*-
"""
Created on Fri May 24 10:34:55 2019
...
Map = AWG_map(sweep_dim=[1,101],waveform_duration=4100)
...
#decay_bools = [False,True,False,True]
#T0_bools = [False,False,True,False,False,False]
#Tplus_bools = [False,False,True, False]
...
#pulse = WE.Pulse(name = 'Second_pulse_RP1',\
#                 channel = 'awg_RP1',\
#                 Amplitude = -4.5,\
#                 Duration = 500.,\
#                 unit = 'ns',\
...
#pulse = WE.Pulse(name = 'Mix_pulse_RP1',\
#                 channel = 'awg_RP1',\
#                 Amplitude = -1.2,\
#                 Duration = 500.,\
#                 unit = 'ns',\
#                 Delay = 2000.,\
#                 )
#pulse.ramp_parameter('V_{positive pulse, RP1}','Amplitude',0,-4.5,2)
...
#                 Delay = 2000.,\
#                 )
##ramp.ramp_parameter('V0_{rampup, RP1}','Vstart',0.5,-1.5,1)
##ramp.ramp_parameter('V1_{rampup, RP1}','Vstop',-1,-2.5,1)
#ramp.ramp_parameter('t_{rampup, RP1}','Tramp',0.,10000.,1)
##ramp.ramp_parameter('dt_{rampup, RP1}','Delay',200.,450.,2)
#Map.add_object(ramp)
...
rabi.ramp_parameter('t_{exch, RP1}','Texch',200,0,1)
#rabi.ramp_parameter('t_{exch, RP1}','Texch',150,0,1)
#rabi.ramp_parameter('V_{exch, RP1}','Vexch',-2.,-1.1,2)
