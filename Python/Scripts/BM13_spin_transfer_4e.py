...
#Map.sequence.append(['RH2',-0.05]) # 0
...
Map.sequence.append(['RH1',0.3])  # MIXING
...
Map.sequence.append(['LH2',0.064])

Map.sequence.append(['RH2',0.3])   # BACK RIGHT
Map.sequence.append(['RH3',-0.15])
Map.sequence.append(['RH1',0.])

#Map.sequence.append(['LH3',0.22]) # TUNNEL SELECTIVE L
#Map.sequence.append(['LH3',-0.3])
#
#Map.sequence.append(['RH2',-0.357]) # TUNNEL SELECTIVE R
...
#Map.segment_param = [59.985, 53, 17]
#Map.segment_param = [63.218, 56, 17]
Map.segment_param = [71.824, 64, 17]
#Map.segment_param = [75.051, 68, 17]
#
#Map.ramp_slot(6,'dLH2_{load}',-0.05,0.07,1)
#Map.ramp_slot(6,'dLH2_{load}',-0.06,0.12,1)
...
#Map.ramp_slot(14,'dLH2_{wait}',0.3,-0.3,2)
#Map.ramp_slot(15,'dLH3_{wait}',0.,+0.3,2)
...
#Map.ramp_slot(22,'dRH1_{sending}',0.0,0.3,1)
Map.ramp_slot(22,'dRH1_{sending}',-0.1,0.35,1)
