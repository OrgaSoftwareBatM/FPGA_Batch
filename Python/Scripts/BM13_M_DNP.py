...
Map.sequence.append(['RH1',+0.485])
Map.sequence.append(['RH3',-0.15])    #same pos. as decay
Map.sequence.append(['RH2',0.03])


#Map.sequence.append(['RH2',0.3])    # MIXING POS RIGHT
#Map.sequence.append(['RH3',-0.15])    #test
