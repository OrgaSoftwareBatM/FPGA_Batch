...
for _ in range(10):
    ...
    Map.sequence.append(['Trigger','1000']) # PREP T+ et decay
    Map.sequence.append(['Trigger','1010'])
...
#Map.sequence.append(['Timing',20]) #Wait hypefine to return random

Map.sequence.append(['Jump',4])


#Map.sweep_dim = [48000,10]
Map.sweep_dim = [51,2000]
...
#Map.segment_param = [157.986,150,18] #N = 50
Map.segment_param = [66.691,58,18] #N = 10
