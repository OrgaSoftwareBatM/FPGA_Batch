...
Map.sequence.append(['RH1',-0.15]) # Wormhole
Map.sequence.append(['RH2',0.3])

Map.sequence.append(['RH3',-0.3])    # MANIP POS
Map.sequence.append(['RH1',0.5])
Map.sequence.append(['RH2',0.05])

Map.sequence.append(['Trigger','1100']) # AWG
Map.sequence.append(['RH1',0.4])
Map.sequence.append(['RH1',0.5])
...
#Map.ramp_slot(12,'dRH2_{wait}',-0.10,0.10,2)
#Map.ramp_slot(10,'dRH3_{wait}',-0.15,-0.75,3)
