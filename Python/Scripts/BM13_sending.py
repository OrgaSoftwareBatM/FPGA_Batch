...
Map.sequence.append(['LH3',0.35])  # load L
Map.sequence.append(['LH2',-0.07])
Map.sequence.append(['LH3',0.15])
Map.sequence.append(['LH2',0.1])

Map.sequence.append(['RH3',0.15])   # load R
Map.sequence.append(['RH2',-0.024])
...
Map.sequence.append(['LH3',-0.3]) # Metastable L
Map.sequence.append(['LH2',0.3])
Map.sequence.append(['LH1',0.0])

Map.sequence.append(['RH3',-0.6]) # Metastable R
Map.sequence.append(['RH2',0.])
...
Map.sequence.append(['LH1',0.]) # Back L
Map.sequence.append(['LH2',0.1])
Map.sequence.append(['LH3',0.15])

Map.sequence.append(['RH1',0.]) # Back R
Map.sequence.append(['RH2',0.])
Map.sequence.append(['RH3',-0.15])
...
Map.sweep_dim = [50,51,51,20]
Map.init_val['LD1'] = -0.6905
Map.init_val['LD2'] = -0.826
Map.init_val['RD1'] = -0.7085
Map.init_val['RD2'] = -1.042

#Map.segment_param = [137.709, 27, 47]
Map.segment_param = [137.709, 27, 47, 74, 47]
...
#Map.ramp_slot(16,'dLH2_{wait}',-0.3,0.3,1)
