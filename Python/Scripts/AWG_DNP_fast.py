...
Map = AWG_map(sweep_dim=[11,51],waveform_duration=4100)
...
Map.add_object(pulse,enable_bools=Tplus_decay_bools)
...
#ramp.ramp_parameter('dt_{rampup, RP1}','Delay',200.,450.,2)
Map.add_object(ramp,enable_bools=Tplus_decay_bools)
