...
Map = AWG_map(sweep_dim=[1,49],waveform_duration=4000)
...
#pulse.ramp_parameter('V_{mixing, RP1}','Amplitude',0.,-2.5,1)
##pulse.ramp_parameter('t_{mixing, RP1}','Duration',0.,600.,2)
...
rabi.ramp_parameter('t_{exch, RP1}','Texch',40,0,1)
...
rabi.ramp_parameter('t_{exch, RP2}','Texch',40,0,1)
